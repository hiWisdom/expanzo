...
export default function Contact() {
    ...
    return(
       ...
       <meta name="lp-version" content="v6.23.11"/>
        ...
        <link rel="icon" type="image/x-icon" href="pictures/testing picture/images-7.png"/>       
 
        </Head>

        <header className={styles.header}>  

        <div className={styles["header_container"] + " " + styles["head_nav_container"]}>

            <input type="checkbox" id="e_checkbox" className={styles.e_checkbox_menu}/>
            <label for="e_checkbox" className={styles.e_checkbox} onClick={()=> setActive(!active)}>
            <i className="fa fa-bars checkbotton"></i>
            </label>


            <ul className={styles.e_nav_contents}>

                <div className={styles.e_nav_contents_one}>
                    <h2 className={styles.e_nav_contents_one_dashboard} onClick={()=> router.push('/')} >DASHBOARD</h2>
                    <h2 className={styles.e_nav_contents_one_contact} onClick={()=> router.push('/contact')}>CONTACT</h2>
                </div>

                <span className={styles.e_contact_logo}>
                    <svg width="225.458" height="118.111" viewBox="0 0 225.458 118.111">
                        ...
                        <rect id="Rectangle_78" data-name="Rectangle 78" width="9.924" height="7.929" transform="translate(200.844 283.466)" fill="white"/>
                        <rect id="Rectangle_79" data-name="Rectangle 79" width="9.919" height="40.488" transform="translate(263.696 250.907)" fill="white"/>
                        <rect id="Rectangle_80" data-name="Rectangle 80" width="9.919" height="27.792" transform="translate(251.13 263.603)" fill="white"/>
                        <rect id="Rectangle_81" data-name="Rectangle 81" width="9.928" height="20.615" transform="translate(238.555 270.78)" fill="white"/>
                        <rect id="Rectangle_82" data-name="Rectangle 82" width="9.918" height="16.11" transform="translate(225.99 275.285)" fill="white"/>
                        <rect id="Rectangle_83" data-name="Rectangle 83" width="9.924" height="10.494" transform="translate(213.414 280.901)" fill="white"/>
                ...
                <div className={styles.e_nav_contents_two}>

                    <i className="fa fa-user e_nav_contents_two_icons e_nav_contents_two_icon_one"></i> <h2 className={styles.e_login_text}>LOGIN</h2>

                    <i className="fa fa-pencil e_nav_contents_two_icons e_nav_contents_two_icon_two"></i> <h2 className={styles.e_registration_text}>REGISTRATION</h2>

                </div>
            </ul>


            <ul className={active ? styles.activeE_more_contents : styles.e_more_contents}>



                <span className={styles.closeMenuStyle}>

            <svg xmlns="http://www.w3.org/2000/svg" width="225.458" height="118.111" viewBox="0 0 225.458 118.111">
                <g id="Group_46" data-name="Group 46" transform="translate(-126.281 -242.833)">
                <path id="Path_15315" data-name="Path 15315" d="M235.531,249.652l-3.99,3.091-23.335,18.052,3.1,4,23.325-18.056,5.123,6.621,3.1,3.993,4-3.091,11.589-8.977,3.235,4.172,4.371-8.32,4.36-8.306-9.136,2.144-9.146,2.139,3.22,4.167-11.589,8.983-5.124-6.617-3.1-4" transform="translate(-7.61)" fill="#00c39e" fill-rule="evenodd"/>
                ...
                <h2 className={styles.e_more_contents_links}>DASHBOARD</h2>
                <h2 className={styles.e_more_contents_links}>CONTACT</h2>
        ...
        <div className={styles.e_main_content}>


        <h2 className={styles.e_main_content_title}>Contact</h2> 



        <ul className={styles.e_main_content_container_list}>


                <i className="fa fa-map-marker 
                e_main_content_icons_location">

                </i>
                <li className={styles.e_main_content_list}>Headquarters
                    <ul className={styles.e_main_content_list_headquaters_address}>
                        <p>DHO s.r.o Borivojova 878/35 130 00 Praha 3</p>
                    </ul>
                ...
                <span className="fa fa-envelope e_main_content_icons e_main_content_icons_mail"></span>
                
                <li className={styles.e_main_content_list}>Email
                    <ul classsName={styles.e_main_content_container}>
                        <p classsName={styles.e_main_content_details}>info@expanzo.com</p>
                    </ul>
                </li>
        ...
        <div className={styles.e_footer_content}>
        ...
        <ul className={styles.e_footer_content_container_list}>
            <li className={styles.e_footer_content_list} id={styles.e_footer_content_contacts}>CONTACTS</li>
            <li className={styles.e_footer_content_list} id={styles.e_footer_content_phones}>PHONES</li>
            <li className={styles.e_footer_content_list} id={styles.e_footer_content_topsearch}>TOP SEARCH</li>
        </ul>
