      ...
      <main className={styles.main}>
        ...
        <div className={styles.e_main_content}>
          ...
          <ul className={styles.e_main_content_container_list}>
              <li className="e_main_content_list e_main_content_list_all">All</li>

              <li className="e_main_content_list e_main_content_list_companies">Companies</li>

              <li className="e_main_content_list e_main_content_list_phones">Phones</li>
          </ul>
